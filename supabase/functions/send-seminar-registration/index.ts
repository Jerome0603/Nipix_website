...
serve(async (req) => {
  ...
  try {
    ...
    if (!name || !email || !phone || !session || !seminarTitle) {
    ...
    await resend.emails.send({
      ...
      subject: `New Seminar Registration - ${seminarTitle}`,
      html: `
        ...
        <table width="600" align="center" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:30px;">
              ...
              <p><strong>Seminar:</strong> ${seminarTitle}</p>
              <p><strong>Name:</strong> ${name}</p>
              <p><strong>Email:</strong> ${email}</p>
              <p><strong>Phone:</strong> ${phone}</p>
              <p><strong>Organization:</strong> ${organization || "N/A"}</p>
              <p><strong>Session:</strong> ${session}</p>
              <p><strong>Date:</strong> ${seminarDate || "N/A"}</p>
            </td>
          </tr>
        </table>
      </div>
    ...
    await resend.emails.send({
      from: "Nipix Technology <admin@nipixtechnology.com>",
      to: [email],
      subject: `Registration Confirmed - ${seminarTitle} Seminar`,
      html: `
      <div style="font-family:Arial;background:#f4f6f9;padding:40px 0;">
        <table width="600" align="center" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;">
          <tr>
          ...
          <tr>
              <td style="padding:30px;font-size:14px;">
                ...
                <p style="font-weight:bold;font-size:16px;">${seminarTitle} seminar</p>
